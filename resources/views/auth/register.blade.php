...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets-mazer/compiled/svg/favicon.svg') }}"type="image/x-icon">
    ...
    <link rel="stylesheet" href="{{ asset('assets-mazer/compiled/css/auth.css') }}">
</head>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="/register" method="POST">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="email" class="form-control"
                                                    ...
                                                    value="{{ old('email') }}" autocapitalize="none" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="password" class="sr-only">Password</label>
                                                {{-- <span class="float-end"><a href="#">Forgot password
                                                        ?</a></span> --}}
                                        ...
                                        <div>
                                            <p class="m-0 mt-3 text-center">Sudah punya akun ?<a
                                                    href="/login">silahkan login disini</a></p>
                                        </div>
                                    </form>
